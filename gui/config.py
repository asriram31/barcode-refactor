...
class BinarizationConfigGUI:
    ...
    _core_config: BinarizationConfig
...
class OpticalFlowConfigGUI:
    ...
    _core_config: OpticalFlowConfig
...
class IntensityDistributionConfigGUI:
    ...
    _core_config: IntensityDistributionConfig
...
class AggregationConfigGUI:
    ...
    _core_config: AggregationConfig
